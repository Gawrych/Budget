...
public class AddNewComingElement extends Fragment {
    ...
    public void onViewCreated(@NonNull View rootView, @Nullable Bundle savedInstanceState) {
        ...
        TextInputEditText timeBetweenPay = rootView.findViewById(R.id.timeBetweenPay);
        ...
        cyclicalSwitch.setOnClickListener(v -> {
            if (cyclicalSwitch.isChecked()) {
                howManyTimesLayout.setVisibility(View.VISIBLE);
                timeBetweenPayLayout.setVisibility(View.VISIBLE);
            } else {
                howManyTimesLayout.setVisibility(View.INVISIBLE);
                timeBetweenPayLayout.setVisibility(View.INVISIBLE);
            }
        });
